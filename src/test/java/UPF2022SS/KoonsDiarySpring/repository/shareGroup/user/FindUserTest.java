...
class FindUserTest {
    ...
    @Test
    @DisplayName("공유일기 유저 생성 및 조회")
    void findShareGroupUserByUserAndShareGroup() throws JsonProcessingException {
        ...
        Optional<ShareGroupUser> findShareGroupUser = shareGroupUserJpaRepository.findShareGroupUserByUserAndShareGroup(user.get(), shareGroup.get());

        assertThat(findShareGroupUser.get()).isEqualTo(shareGroupUser);
