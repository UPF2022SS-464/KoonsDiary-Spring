...
public class UserApiController {
    ...
    public Boolean isUsernameDuplicated(@Valid @RequestBody final Validation.Id.RequestDto requestDto) {
        return userService.validateDuplicateUserId(requestDto);
    }

    // 이메일 유효성 검증 api
    @PostMapping(value = "/user/validateEmail")
    public Boolean isEmailDuplicated(@Valid @RequestBody final Validation.Email.RequestDto requestDto) {
        return userService.validateDuplicateUserEmail(requestDto);
    }
